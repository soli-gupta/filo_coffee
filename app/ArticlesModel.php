...
class ArticlesModel extends Model
{
    ...
    protected $fillable = array('id', 'name', 'slug', 'image', 'short_description', 'description', 'practice', 'image2', 'status', 'page_title', 'meta_keywords', 'meta_description', 'posted_by', 'posted_date', 'sorting');
