...
@section('content')
@php
$activeLetter = request('people') ? request('people') : 'A';
...
<section class="keypeoplesec secpadd60" data-aos="fade-up">
    <div class="container">
        <div class="customcontainer">
            <h2>Search</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                            <div class="form-group">
                                <input type="text" name="name" placeholder="Find a professional">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                            <div class="form-group">
                                <select name="location">
                                    ...
                                    <option value="{{$location->name}}" {{ $location->name == $location ? 'selected' : '' }}>{{$location->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
            ...
            <div class="keypeoplelist peoplepage">
                <div class="row gx-5">
                    @if (count($peoples) > 0)
