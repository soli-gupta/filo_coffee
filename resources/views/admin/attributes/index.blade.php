...
@section('content')
  ...
  <th  class="{{ isset($_GET['orderBy'])?(($_GET['sorting']=='type')?(($_GET['orderBy']=='ASC')?'sorting':'sorting'):'sorting'):'sorting' }}"><a onclick="sorting('type','{{ isset($_GET['orderBy'])?(($_GET['sorting']=='type'  && $_GET['orderBy']=='ASC' )?'DESC':'ASC'):'DESC' }}')">Type</a></th> 
