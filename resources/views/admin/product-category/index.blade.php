                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <div class="row filter-input">
                     ...
                     <div class="col-xs-2">
                        <label>Name</label>
                        <input type="text" placeholder="Filter by Name" class="form-control nospecial  " id="name" name="name" value="<?php echo (isset($_GET['name']))?$_GET['name']:'';?>">
                      </div>  
                      ...
                      <div class="col-xs-2 ">
                        <label>Slug</label>
                        <input type="text" placeholder="Filter by Slug" class="form-control nospecial  " id="slug" name="slug"  value="<?php echo (isset($_GET['slug']))?$_GET['slug']:'';?>">
                      </div> 
