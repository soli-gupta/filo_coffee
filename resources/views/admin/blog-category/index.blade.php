                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <div class="row filter-input">
                     ...
                     <div class="col-xs-2">
                        <label>Title</label>
                        <input type="text" class="form-control nospecial  " id="name" name="name" placeholder="Filter by Title" value="<?php echo (isset($_GET['name']))?$_GET['name']:'';?>">
                      </div>  
                    ...
                    @foreach(Config::get('constants.CONS_STATUS_ARRAY') as $key=>$val):
                          ...
                          <option value="{{$key}}" {{ (isset($_GET['status']) && $_GET['status']!='' && $_GET['status']==$key)?'selected="selected"':'' }} >{{$val}}</option>
