                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <tbody>
                                <tr>
                                    ...
                                    <th class="{{ isset($_GET['orderBy'])?(($_GET['sorting']=='name')?(($_GET['orderBy']=='ASC')?'sorting':'sorting'):'sorting'):'sorting' }}"><a onclick="sorting('name','{{ isset($_GET['orderBy'])?(($_GET['sorting']=='name'  && $_GET['orderBy']=='ASC' )?'DESC':'ASC'):'DESC' }}')">Service Title</a></th>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $data_row->name }}</td>
                                    <td> {{ $data_row->short_description }}</td>
