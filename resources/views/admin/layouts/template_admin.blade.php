            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="container">
                    <div class="navbar-header">
                        <a href="<?php echo url(ADMIN_FOLDER); ?>" class="navbar-brand"><b>{{env('APP_NAME')}}</b> Admin</a>
                        ...
                        dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="<?php echo ($page_name == 'cms-banner') ? 'active' : '' ?>">
                                        <a href="<?php echo ADMIN_URL; ?>/cms-banner"> <span>CMS Image Content</span></a>
                                    </li>
                                    @endif

                                    @if(in_array('media-gallery',$admin_modules_array) ||
                                    in_array('all-modules',$admin_modules_array))
                                    <li class="<?php echo ($page_name == 'media-gallery') ? 'active' : '' ?>">
                                        <a href="<?php echo ADMIN_URL; ?>/media-gallery"> <span>Gallery</span></a>
                                    </li>
                                    @endif
                            ...
                            <li class="<?php echo ($page_name == 'setting' || $page_name == 'profile' || $page_name == 'admin-user' || $page_name == 'redirect-url') ? 'active' : '' ?> dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="<?php echo ($page_name == 'redirect-url') ? 'active' : '' ?>"><a href="<?php echo ADMIN_URL; ?>/redirect-url"><span>Redirect 404 Urls</span></a></li>
                                    @endif


                                    @if(in_array('setting',$admin_modules_array) || in_array('all-modules',$admin_modules_array))
